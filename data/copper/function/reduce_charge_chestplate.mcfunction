item replace entity 9-0-0-0-9 contents from entity @s armor.chest
...
item modify entity @s[scores={charge_chestplate = 1..}] armor.chest copper:copy_charge
item modify entity @s[scores={charge_chestplate = ..1}] armor.chest copper:uncharge